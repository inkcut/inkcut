...
from geom import simpletransform
from graphic import Graphic, SVG
import logging
logger = logging.getLogger('inkcut_lib')

CUTTING_ORDERS = ['One copy at a time', 'Best tracking', 'Shortest Path']
...
class Plot:
    ...
    def get_finish_position(self):
        return self._properties['finish_position']
    ...
    def get_mirror_x_status(self):
        return self._properties['axis_mirror_x']
    
    def get_mirror_y_status(self):
        return self._properties['axis_mirror_y']
    
    def get_align_center_x_status(self):
        return self._properties['align_center_x']
    
    def get_align_center_y_status(self):
        return self._properties['align_center_y']
    ...
    def set_position(self,x,y):
        ...
        logger.debug("set_position(%s,%s)"%(x,y))
    ...
    def set_align_center_x(self,enabled):
        ...
        logger.debug("set_align_center_x(%s)"%enabled)
    ...
    def set_align_center_y(self,enabled):
        ...
        logger.debug("set_align_center_y(%s)"%enabled)
        x,y = self.get_position()
        if enabled:
    ...
    def set_padding(self,top=None,right=None,bottom=None,left=None):
        ...
        """
        logger.debug("set_padding(%s,%s,%s,%s)"%(top,right,bottom,left))
    ...
    def set_spacing(self,x=None,y=None):
        ...
        logger.debug("set_spacing(%s,%s)"%(x,y))
    ...
    def set_weedline(self,enabled):
        ...
        assert type(enabled) == bool, "enabled must be a bool"
        logger.debug("set_weedline(%s)"%(enabled))
    ...
    def set_weedline_padding(self,padding):
        ...
        logger.debug("set_weedline_padding(%s)"%(padding))
    ...
    def set_rotation(self,degrees):
        ...
        logger.debug("set_rotation(%s)"%(degrees))
    ...
    def set_auto_rotate(self,enabled):
        ...
        assert type(enabled) == bool, "enabled must be a bool."
        logger.debug("set_auto_rotate(%s)"%enabled)
    ...
    def set_cutting_order(self,mode=None):
        """ """
        assert mode in CUTTING_ORDERS
        self._properties['order'] = mode
        return False
